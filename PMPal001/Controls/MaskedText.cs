...
namespace PMPal
{
    ...
    {
        public static string FormatText(string Text, TextBoxMask format)
        {
            return formatNumber(Text, format);
        }
        private static string formatNumber(string MaskedNum, TextBoxMask phoneFormat)
        {
            int x;
    ...
    public class MaskedTextBox : MaterialDesignThemes.Wpf.
    {
        ...
        void MaskedTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                tbEntry.Text = TextMask.FormatText(tbEntry.Text, tbEntry.Mask);
            }
        }
    ...
    public class MaskedTextBlock : TextBlock
    {
        ...
        {
            this.Loaded += MaskedTextBlock_Loaded;
        }

        private void MaskedTextBlock_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            if(!string.IsNullOrWhiteSpace(this.Text))
                this.Text = TextMask.FormatText(this.Text, this.Mask);
        }
